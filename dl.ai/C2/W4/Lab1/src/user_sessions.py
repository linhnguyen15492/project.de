...
RAW_DATA_BUCKET = "de-c2w4lab1-455282221683-us-east-1-raw-data"
### END CODE HERE ###
...
with DAG(
    ...
    def get_new_users(**context):
        ...
        response = requests.get(
            f"http://54.243.59.167:8000/users?start_date={start_date}&end_date={end_date}"
        )
        ### END CODE HERE ###
    ...
    def get_session(**context):
        ...
        # APIEndpoint to fill the `<API_ENDPOINT>` placeholder.
        response = requests.get(
            f"http://54.243.59.167:8000/sessions?start_date={start_date}&end_date={end_date}"
        )
        ### END CODE HERE ###
    ...
    [save_complete_session_task, get_new_users_task] >> cleanup_task
